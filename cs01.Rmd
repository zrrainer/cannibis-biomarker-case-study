...
note: do we care about occasional/frequent user? might be more informative if coloured by placebo/non placedo
```{r, cache = TRUE}
scatter_wb <- map(compounds_BR, ~ compound_scatterplot_group( 
    dataset=BR, 
    compound=.x, 
    timepoints=timepoints_BR))
```
